...
EMAIL_HOST_USER = 'chitownslilb@gmail.com' # - Enter your GMAIL address # The host email that sends password reset emails
EMAIL_HOST_PASSWORD = 'Hatemenow1' # - Enter your app password 
